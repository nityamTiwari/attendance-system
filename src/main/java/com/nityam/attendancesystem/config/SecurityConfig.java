...
import com.nityam.attendancesystem.auth.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(EmployeeUserDetailsService employeeUserDetailsService, JwtAuthenticationFilter jwtAuthenticationFilter) {
